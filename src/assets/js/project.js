...
function renderProject() {
  ...
  for (let index = 0; index < projects.length; index++) {
    html += `<div class="card rounded d-flex flex-wrap m-4" style="width: 20rem;">
                      <a href="/project-detail/1">
                      <img src="${projects[index].uploadImage}" class="card-img-top p-3" alt="project image">
                      </a>
                    <div class="card-body">
                        <h3 class="card-title" href="/project-detail/1">${projects[index].projectName}</a></h3>
                    ...
                    ${projects[index].nodeJs ? `<img class="mx-3" src="assets/img/logo-playstore.png" alt="" width="30" height="30">` : ''}
                    ${projects[index].nextJs ? `<img class="mx-3" src="assets/img/logo-android.png" alt="" width="31" height="31">` : ''}
                    ${projects[index].reactJs ? `<img class="mx-3" src="assets/img/logo-java.png" alt="" width="29" height="29">` : ''}
                    ${projects[index].typeScript ? `<img class="mx-3" src="assets/img/logo-javascript.png" alt="" width="32" height="32">` : ''}
                    </div>
